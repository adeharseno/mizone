...
class Brands extends Controller {
	protected $dir = "cw-admin/contents/brands/";
	...
	public function save($id)
	{
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			if ($id){
				$this->db->update("brands", $insert, array("id"=>$id));
			...
			redirect(PATH_CW .  'brands/edit/' . $id,'refresh');
    	}
	}
	...
	public function action($type, $id, $ajax = false)
	{
		...
		$this->db->update("brands", $set, $where);
