		...
		<table class="table responsive-data-table table-hover js-table" reorder="true">
			...
			<?php foreach ($table as $key => $value): ?>
				...
				<tr class="js-click-checkbox" id="<?php echo $value["id"] ?>">
					...
					<td>
						<div class="item thumbnail-box"><img style="max-width:100px;max-height:100px;" src="../<?php echo image_get_src($value["bg_d"]) ?>"></div>
					</td>
					<td>
						<div class="item thumbnail-box"><img style="max-width:100px;max-height:100px;" src="../<?php echo image_get_src($value["content_d"]) ?>"></div>
					</td>
