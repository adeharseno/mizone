          ...
          <div class="modal-content">
            <div class="modal-body p-0 rounded-0">
              ...
              <?php if( !empty($value["video_url"]) ): ?>
                ...
                <video id="myVideo-<?php echo $value['id']; ?>" class="video-js vjs-fluid vjs-default-skin" controls width="640" height="264" preload="none"
      ...
      <?php if( !empty($value['video']) || !empty($value["video_url"]) ):?>
        $('#videocontent-<?php echo $value['id']; ?>').on("hidden.bs.modal", function (i) {
          $(".main-slider").slick("slickPlay"),
            videojs("myVideo-<?php echo $value['id']; ?>").ready(function () {
                this.pause();
            });
        });
