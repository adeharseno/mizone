<div class="row">
	...
	<div class="col-md-5">
		<div class="pull-right">
			...
			<a href="distributors_category" class="btn btn-primary btn-inna">ADD CATEGORY</a>
		</div>
	</div>
				...
				<tr class="js-click-checkbox" id="<?php echo $value["id"] ?>">
					...
					<td>
						<div class="user">
							...
							<div class="item desc">
								<a href="<?php echo $class_name ?>/edit/<?php echo  $value["id"] ?>"><b><?php echo $value["name"] ?></b></a>
							</div>
						</div>
					</td>
					...
					<td><?php echo $this->base->field("title", "distributors_sub_category", $value["distributors_sub_category_id"])  ?></td>
				</tr>
				<?php $i++ ?>
			<?php endforeach ?>	
			</tbody>
