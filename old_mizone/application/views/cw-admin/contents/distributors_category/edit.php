	...
	<form class="form" role="form" action="<?php echo $class_name ?>/edit/<?php echo $id ?>" method="post" autocomplete="off" accept-charset="utf-8" enctype="multipart/form-data">
        ...
        <div class="col-md-12 mt25 <?php echo ($id) ? "" : "hidden" ?>">
            <?php 
                $where = null;
                $where["flag != 99"] = null;
                $where["distributor_category_id"] = $id;
            ...
            <div class="row">
                <div class="hidden">
                    <input type="text" name="href_orderby" value="distributors_sub_category/order">
                </div>
                <div class="col-md-8">
                    <div class="box-desc">
                        <div class="item">
                        ...
                        <div class="item">
                            <ul class="menu-checked hidden">
                                <li><a href="" class="js-action-table" find="js-table" url="distributors_sub_category/active"><i class="ti-check" data-toggle="tooltip" data-placement="top" title="" data-original-title="Active" ></i></a></li>
                                <li><a href="" class="js-action-table" find="js-table" url="distributors_sub_category/blocked"><i class="ti-na" data-toggle="tooltip" data-placement="top" title="" data-original-title="Not Active" ></i></a></li>
                                <li><a href="javascript:;" class="js-click-modal-delete" url="distributors_sub_category/delete"><i class="ti-trash" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" ></i></a></li>
                            </ul>
                        </div>
                        <div class="item">
                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        <a  class="btn btn-primary btn-inna" href="distributors_sub_category/edit/<?php echo $id ?>">ADD SUB CATEGORY</a>
                    </div>
                </div>
                                ...
                                <tr class="js-click-checkbox" id="<?php echo $value["id"] ?>">
                                    ...
                                    <td>
                                        <div class="user">
                                            ...
                                            <div class="item desc">
                                                <a href="distributors_sub_category/edit/<?php echo $id ?>/<?php echo $value["id"] ?>" ><b><?php echo $value["title"];  ?></b></a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <?php 
                                         ...
                                         ?>
                                        <a  href="distributors_sub_category/action/<?php echo ($value["flag"]  == 0) ? "blocked" : "active" ?>/<?php echo $value["id"] ?>" class="bullet <?php echo $color ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $copy ?>"></a>
