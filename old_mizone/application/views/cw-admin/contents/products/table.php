...
<div class="hidden">
	...
	<div class="col-md-6">
		<div class="pull-right">
			...
			<a href="products_category" class="btn btn-primary btn-inna">ADD CATEGORY</a>
		...
		<table class="table responsive-data-table table-hover js-table" reorder="true">
			...
			<?php foreach ($table as $key => $value): ?>
				...
				<tr class="js-click-checkbox" id="<?php echo $value["id"] ?>">
					...
					<td><?php echo $this->base->field("title", "products_sub_category", $value["products_sub_category_id"])  ?></td>
				</tr>
				<?php $i++ ?>
			<?php endforeach ?>	
			</tbody>
