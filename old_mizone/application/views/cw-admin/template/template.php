    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="navbar-header">
                                <a href="" class="navbar-brand">
                                    <span class="logo"><img src="../assets/images/all/logo-no-text.png" alt=""/></span>
                                </a>
                            </div>
                            <div class="navbar-collapse nav-responsive-disabled">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="account/edit/<?php echo get_session("user_id") ?>" title="Update Account"><?php echo get_session("user_full_name") ?></a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="collapse navbar-collapse" id="main-navigation">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <!-- <li><a href="videos">VIDEO HOME</a></li> -->
                                    <li><a href="mproducts">Mizone Products</a></li>
        ...
        <script type="text/javascript">
            $(function(){
                ...
                ?>
                <?php 
                    $success_message = get_flashdata("success_message"); 
                    if ($success_message){
                        ?>
