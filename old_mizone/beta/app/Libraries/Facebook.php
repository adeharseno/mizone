...
Class Facebook
{
     ...
     */
    public function is_authenticated($boolean = false)
    {
        $access_token = $this->authenticate($boolean);
    ...
    public function login_url()
    {
        if ($this->config->item('facebook_login_type') == 'canvas'){
            $helper_web = $this->fb->getRedirectLoginHelper();
            
            return $helper_web->getLoginUrl(
        ...
        return $this->helper->getLoginUrl(
            'http:' . base_url() . $this->config->item('facebook_login_redirect_url'),
            $this->config->item('facebook_permissions')
        );
    }
     ...
     */
    private function authenticate($boolean = false)
    {
