...
class fb_autoload {
    ...
    {
        $mod_path = APPPATH . 'libraries/facebook';
    ...
    private function _read_model_dir($dirpath)
    {
        ...
        while (false !== ($filename = readdir($handle)))
        {
            ...
            {
                // var_dump(file_exists("/home/redcommb/public_html/lays_butter_honey/application/libraries/facebook/Helpers/FacebookCanvasHelper.php"));echo "<br>";
                // var_dump(file_exists($filepath));echo "<br>";
                // echo "/home/redcommb/public_html/lays_butter_honey/application/libraries/facebook/Helpers/FacebookCanvasHelper.php";echo "<br>";
                // echo $filepath;exit();
                $name = $filepath;
                require_once $name;
            }
