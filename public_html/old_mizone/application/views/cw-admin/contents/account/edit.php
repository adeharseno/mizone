<div class="row">
	<form class="form-horizontal " role="form" action="account/edit/<?php echo $row["id"] ?>" method="post" autocomplete="off" accept-charset="utf-8" enctype="multipart/form-data">
		<div class="col-md-6">
			<div class="box-desc">
				<div class="item">
		...
		<div class="col-md-6">
			<div class="pull-right">
				<a href="account" class="btn btn-inna btn-outlined mr5">CLOSE</a>
			...
			<div class="form-group">
                ...
                <div class="col-lg-9">
                    ...
                    <?php if (form_error('full_name')): ?>
                        <label class="error"><?php echo form_error('full_name'); ?></label>
                    <?php endif ?>
