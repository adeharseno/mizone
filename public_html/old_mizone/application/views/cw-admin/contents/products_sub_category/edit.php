	...
	<form class="form" role="form" action="<?php echo $class_name ?>/edit/<?php echo $parent_id ?>/<?php echo $row["id"] ?>" method="post" autocomplete="off" accept-charset="utf-8" enctype="multipart/form-data">
		...
		<div class="col-md-6">
			<div class="pull-right">
				<a href="products_category/edit/<?php echo $parent_id ?>" class="btn btn-inna btn-outlined mr5">CLOSE</a>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <div id="cp2" class="input-group colorpicker-component">
                            <input type="text" value="<?php echo (set_value('color'))?set_value('color'):$row["color"] ?>" class="form-control" name="color">
                            ...
                            <div class="row">
                                <div class="col-md-6"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="detail_title[<?php echo $lang_key ?>]" value="<?php echo (set_value('detail_title'))?set_value('detail_title'):(isset($row["detail_title"][$lang_key]) ? $row["detail_title"][$lang_key] : "") ?>">
                                        <?php if (form_error('detail_title')): ?>
                                            <label class="error"><?php echo form_error('detail_title'); ?></label>
                                        <?php endif ?>
                                    </div>
                                    <div class="form-group">
                                        <label>Detail Description</label>
                                        <input class="form-control" type="text" name="detail_desc[<?php echo $lang_key ?>]" value="<?php echo (set_value('detail_desc'))?set_value('detail_desc'):(isset($row["detail_desc"][$lang_key]) ? $row["detail_desc"][$lang_key] : "") ?>">
                                        <?php if (form_error('detail_desc')): ?>
                                            <label class="error"><?php echo form_error('detail_desc'); ?></label>
                                        <?php endif ?>
                                    </div>
                                </div>
                            </div>
