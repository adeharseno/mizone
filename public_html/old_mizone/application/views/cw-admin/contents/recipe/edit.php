                        ...
                        <div id="<?php echo $lang_key ?>" class="tab-pane fade <?php echo ($i==0) ? "active in" : "" ?>">
                            <div class="row">
                                <div class="col-md-3 text-left">
                                    ...
                                    <div class="form-group">
                                        <label>Image <sup>480x112</sup></label>
                                        <div class="form-group">
                                            <?php 
                                                $data = null;
                                ...
                                <div class="col-md-9"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control tinymce" rows="10" name="informasi_resep[<?php echo $lang_key ?>]"><?php echo (set_value('informasi_resep['.$lang_key.']'))?set_value('informasi_resep['.$lang_key.']'):(isset($row["informasi_resep"][$lang_key]) ? $row["informasi_resep"][$lang_key] : "") ?></textarea>  
                                        <?php if (form_error('informasi_resep['.$lang_key.']')): ?>
                                            <label class="error"><?php echo form_error('informasi_resep['.$lang_key.']'); ?></label>
                                        <?php endif ?>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>How to</label>
                                        <textarea class="form-control tinymce" rows="10" name="how_to[<?php echo $lang_key ?>]"><?php echo (set_value('how_to['.$lang_key.']'))?set_value('how_to['.$lang_key.']'):(isset($row["how_to"][$lang_key]) ? $row["how_to"][$lang_key] : "") ?></textarea>  
                                        <?php if (form_error('how_to['.$lang_key.']')): ?>
                                            <label class="error"><?php echo form_error('how_to['.$lang_key.']'); ?></label>
                                        <?php endif ?>
                                    </div>
                                </div>
                            </div>
