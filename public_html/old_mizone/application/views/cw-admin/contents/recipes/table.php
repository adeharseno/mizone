...
<div class="hidden">
	...
	<div class="col-md-6">
		<div class="pull-right">
			...
			<a href="recipes_category" class="btn btn-primary btn-inna">ADD CATEGORY</a>
			<a href="recipes_festival" class="btn btn-primary btn-inna">ADD FESTIVAL</a>
		</div>
	</div>
		...
		<table class="table responsive-data-table table-hover js-table" reorder="true">
			...
			<?php foreach ($table as $key => $value): ?>
				...
				<tr class="js-click-checkbox" id="<?php echo $value["id"] ?>">
					...
					<td>
						<div class="user">
							<div class="item thumbnail-box"><img src="../<?php echo $this->image_path->get_src($value["icon"]) ?>"></div>
							<div class="item desc">
					...
					<td><?php echo $this->base->field("title", "recipes_sub_category", $value["recipes_sub_category_id"])  ?></td>
				</tr>
				<?php $i++ ?>
			<?php endforeach ?>	
			</tbody>
