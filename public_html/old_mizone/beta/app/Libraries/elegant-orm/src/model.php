...
class Model {
	...
	protected $countAllResults = null;
	...
	protected function get($columns = array())
	{
		...
		$this->publicPagingBuilder = clone $this->queryBuilder;
	...
	protected function paginate($per_page = 20, $uri_key = 'page', $link_suffix = '')
	{
		...
		$this->countAllResults = $builder->count_all_results();
		...
		$config['total_rows'] = $this->countAllResults;
